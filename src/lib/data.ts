...
export const TOURS: Tour[] = [
    ...
    },
    {
        ...
        description: "Deep eco-tourism jungle safari in the Anamalai Hills. Visit the giant Kannimara Teak (world's oldest), enjoy bamboo rafting, and spot wild elephants & tigers.",
