...
export const metadata: Metadata = {
  ...
  description: "Contact Vela Travels at Aliyur, Near NSS College, Nenmara, Palakkad. Call +91 9207050525 for 24/7 Car Rentals, Airport Taxis & Tour Packages.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "24/7 Taxi & Car Rental Contact: +91 9207050525. Located at Aliyur, Near NSS College, Nenmara, Palakkad.",
    url: `${siteUrl}/contact`,
  ...
  twitter: {
    ...
    description: "Contact Vela Travels at Aliyur, Near NSS College, Nenmara, Palakkad. Call +91 9207050525.",
