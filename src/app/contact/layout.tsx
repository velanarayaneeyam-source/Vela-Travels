...
export const metadata: Metadata = {
  ...
  description: "Contact Vela Travels at Ayilur, Near NSS College, Nenmara, Palakkad. Call +91 9207050525 for 24/7 Premium Fleets, Airport Taxis & Tour Packages.",
  keywords: [
    "Contact Vela Travels",
    "Premium Fleet Phone Number Nenmara",
  ...
  openGraph: {
    ...
    description: "24/7 Taxi & Premium Fleets Contact: +91 9207050525. Located at Ayilur, Near NSS College, Nenmara, Palakkad.",
    url: `${siteUrl}/contact`,
